...
ALTER TABLE COMMON_LOOKUP ADD COMMON_LOOKUP_CODE VARCHAR2(1);
...
ALTER TABLE COMMON_LOOKUP MODIFY ( COMMON_LOOKUP_TABLE CONSTRAINT NN_CLOOKUP_8 NOT NULL);
ALTER TABLE COMMON_LOOKUP MODIFY ( COMMON_LOOKUP_COLUMN CONSTRAINT NN_CLOOKUP_9 NOT NULL);

--ALTER TABLE COMMON_LOOKUP ADD CONSTRAINT NN_CLOOKUP_8 ( COMMON_LOOKUP_TABLE CONSTRAINT NOT NULL);
--ALTER TABLE COMMON_LOOKUP ADD CONSTRAINT NN_CLOOKUP_9 ( COMMON_LOOKUP_COLUMN CONSTRAINT NOT NULL);
